...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--baseline-dir", type=Path, default=Path("/kaggle/working/artifacts/baselines"))
    parser.add_argument("--tpu-dir", type=Path, default=Path("/kaggle/working/artifacts/tpu"))
...
def main() -> int:
    ...
    args = parse_args()
    LOGGER.info(
        "Bootstrap starting | repo=%s | ref=%s | stage=%s | repo_dir=%s",
        args.github_repo,
        args.github_ref,
        args.stage,
        args.repo_dir,
